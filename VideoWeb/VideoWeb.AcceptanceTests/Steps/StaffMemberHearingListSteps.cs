...
{
    [Binding]
    public class StaffMemberHearingListSteps : ISteps
    {
        private readonly Dictionary<UserDto, UserBrowser> _browsers;
        private readonly TestContext _c;

        public StaffMemberHearingListSteps(Dictionary<UserDto, UserBrowser> browsers, TestContext testContext)
        {
            _browsers = browsers;
            _c = testContext;
        }
        ...
        public void ProgressToNextPage()
        {
            ...
            {
                WhenTheStaffMemberClicksTheCheckEquipmentButton();
            }
            else
            {
                var caseNameElement = StaffMemberHearingListPage.CaseName(_c.Test.Conference.Id);
                ...
                _browsers[_c.CurrentUser].Click(StaffMemberHearingListPage.StartHearingButton(_c.Test.Conference.Id));
        ...
        public void WhenTheStaffMemberClicksTheCheckEquipmentButton()
        {
            _browsers[_c.CurrentUser].Click(StaffMemberHearingListPage.CheckEquipmentButton);
        }
        ...
        public void ThenTheVhoCanSeeAListOfHearingsIncludingTheNewHearing()
        {
            ...
            _browsers[_c.CurrentUser].Driver.WaitUntilVisible(StaffMemberHearingListPage.CaseName(hearingThatShouldBeVisible.Id)).Displayed.Should().BeTrue();
            _browsers[_c.CurrentUser].Driver.WaitUntilVisible(StaffMemberHearingListPage.CaseNumber(hearingThatShouldBeVisible.Id)).Displayed.Should().BeTrue();
