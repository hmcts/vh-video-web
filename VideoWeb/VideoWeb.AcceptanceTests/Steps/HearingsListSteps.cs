...
namespace VideoWeb.AcceptanceTests.Steps
{
    ...
    public sealed class HearingsListSteps : ISteps
    {
        ...
        public void ProgressToNextPage()
        {
            ...
            {
                var startHearing = (_c.CurrentUser.UserType == UserType.Judge || _c.CurrentUser.UserType == UserType.PanelMember || _c.CurrentUser.UserType == UserType.Winger);
                var element = startHearing ? JudgeHearingListPage.StartHearingButton(_c.Test.Conference.Id) : ParticipantHearingListPage.SignInButton(_c.Test.Conference.Id);
