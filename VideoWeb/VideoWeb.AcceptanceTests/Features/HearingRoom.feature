...
Scenario: VHO Monitors Hearing
  ...
  And the VHO can see the participants statuses are Available
  And the VHO can see that all the participants are in the Waiting Room
  When in the Clerk's browser
  ...
  And the VHO can see the participants statuses are In Hearing
  And the VHO can see that all the participants are in the Hearing Room
  When in the Clerk's browser
  When the Clerk clicks close
	Then the user is on the Hearing List page
