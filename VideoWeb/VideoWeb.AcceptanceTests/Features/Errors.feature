...
@VIH-4677 @UnsupportedBrowser
Scenario: Unsupported browser error page
	Given a new browser is open for a Participant
	When the user attempts to login with valid credentials
	Then the user is on the Unsupported Browser page
	And the Unsupported Browser error page displays text of how to rectify the problem