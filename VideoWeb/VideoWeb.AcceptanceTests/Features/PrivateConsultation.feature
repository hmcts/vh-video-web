...
Scenario: Start a private consultation
	Given the the first Individual's user has progressed to the Waiting Room page with a hearing in 10 minutes time
	...
	Then the first Representative's can see the other participant
...
Scenario: Participants cannot request Private consultation in hard-seating area
	Given the the first Individual's user has progressed to the Waiting Room page with a hearing in 3 minutes time
	And the the first Representative's user has progressed to the Waiting Room page for the existing hearing
...
Scenario: Participants cannot request Private consultation in delayed seating area
	Given the the first Individual's user has progressed to the Waiting Room page with a hearing in 1 minute time
	And the the first Representative's user has progressed to the Waiting Room page for the existing hearing
	Then the private consultation link with the first Individual's is not visible
