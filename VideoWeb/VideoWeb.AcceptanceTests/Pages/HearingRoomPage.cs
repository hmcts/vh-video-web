...
namespace VideoWeb.AcceptanceTests.Pages
{
    public static class HearingRoomPage
    {
        ...
        public static readonly By ToggleAudioMuteLocked = By.Id("toggle-audio-mute-locked-img-desktop");
        public static readonly By ToggleHandRaised = By.Id("toggle-hand-raised-img-desktop");
        //public static readonly By ToggleAudioMuteLocked = By.CssSelector("#toggle-audio-mute-img-desktop > span");
