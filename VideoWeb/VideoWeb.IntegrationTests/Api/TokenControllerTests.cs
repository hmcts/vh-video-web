...
namespace VideoWeb.IntegrationTests.Api
{
    public class TokenControllerTests : ControllerTestsBase
    {
        ...
        [Test]
        public async Task Should_get_Jwt_token_when_requested_with_valid_participant_id()
        {
        ...
        [Test]
        public async Task Should_return_bad_request_when_requested_with_invalid_participant_id_for_jwt_token()
        {
