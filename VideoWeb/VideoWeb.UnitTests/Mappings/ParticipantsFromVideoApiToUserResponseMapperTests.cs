...
public class ParticipantsFromVideoApiToUserResponseMapperTests
{
    [Test]
    public void Should_map_list_of_participants_from_video_api()
    {
        ...
        var response = participants.Select(ParticipantUserResponseMapper.Map).ToList();
