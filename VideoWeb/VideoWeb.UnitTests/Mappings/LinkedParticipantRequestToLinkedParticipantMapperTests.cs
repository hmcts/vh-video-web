...
class LinkedParticipantRequestToLinkedParticipantMapperTests
{
    private readonly LinkedParticipantRequest request = new ()
    {
    ...
    public void When_does_not_match_existing_user_Should_map_all_properties_with_ref_id()
    {
        ...
        var linkedParticipant = LinkedParticipantRequestToLinkedParticipantMapper.Map(request, existingParticipants);
