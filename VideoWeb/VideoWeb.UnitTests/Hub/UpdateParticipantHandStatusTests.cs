...
namespace VideoWeb.UnitTests.Hub
{
    public class UpdateParticipantHandStatusTests : EventHubBaseTests
    {
        ...
        public void should_capture_exception_and_log_it()
        {
            ...
            // act / assert
            Func<Task> action = async () => await HubVih11189.UpdateParticipantHandStatus(conferenceId, participantId, false);
        ...
        public async Task should_invoke_conference_management_service()
        {
            ...
            await HubVih11189.UpdateParticipantHandStatus(conferenceId, participantId, handRaised);
