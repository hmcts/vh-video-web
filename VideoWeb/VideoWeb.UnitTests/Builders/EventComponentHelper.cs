...
namespace VideoWeb.UnitTests.Builders
{
    public class EventComponentHelper
    {
        ...
        public List<IEventHandler> GetHandlers()
        {
            ...
            var eventHubContextMock = new Mock<IHubContext<EventHub.Hub.EventHubPR2079, IEventHubClient>>();
        ...
        private List<IEventHandler> GetHandlers(
            Mock<IHubContext<EventHub.Hub.EventHubPR2079, IEventHubClient>> eventHubContextMock,
