    ...
    public static class ConferenceForAdminResponseBuilder
    {
        public static List<ConferenceForAdminResponse> BuildData()
        {
            return new List<ConferenceForAdminResponse> {
                ...
                new ConferenceForAdminResponse{ScheduledDateTime=DateTime.UtcNow.AddHours(1), HearingVenueName="Venue Name 03", Participants = new List<ParticipantResponse>{ new ParticipantResponse
                    {
                    LinkedParticipants = new List<LinkedParticipantResponse>()
                }}, HearingRefId = Guid.NewGuid()},
                new ConferenceForAdminResponse{ScheduledDateTime=DateTime.UtcNow.AddHours(1), HearingVenueName="Venue Name 04", Participants = new List<ParticipantResponse>{ new ParticipantResponse
                {
                    LinkedParticipants = new List<LinkedParticipantResponse>()
                }}, HearingRefId = Guid.NewGuid()},
                new ConferenceForAdminResponse{ScheduledDateTime=DateTime.UtcNow.AddHours(1), HearingVenueName="Venue Name 05", Participants = new List<ParticipantResponse>{ new ParticipantResponse
                {
                    LinkedParticipants = new List<LinkedParticipantResponse>()
                }}, HearingRefId = Guid.NewGuid()},
            };
