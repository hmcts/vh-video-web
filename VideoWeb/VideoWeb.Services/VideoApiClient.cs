...
namespace VideoWeb.Services.Video
{
    ...
    public partial class VideoApiClient : IVideoApiClient
    {
        ...
        public async System.Threading.Tasks.Task<System.Collections.Generic.List<ConferenceSummaryResponse>> GetOpenConferencesByScheduledDateAsync(System.DateTime? scheduledDate, System.Threading.CancellationToken cancellationToken)
        {
            ...
            {
                urlBuilder_.Append("scheduledDate=").Append(System.Uri.EscapeDataString(scheduledDate.Value.ToString("s", System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
            urlBuilder_.Length--;
        ...
        public async System.Threading.Tasks.Task<TestCallScoreResponse> GetIndependentTestCallResultAsync(System.Guid? participantId, System.Threading.CancellationToken cancellationToken)
        {
            ...
            if (participantId != null) 
            {
                urlBuilder_.Append("participantId=").Append(System.Uri.EscapeDataString(ConvertToString(participantId, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
            urlBuilder_.Length--;
    ...
    public partial class AdminConsultationRequest 
    {
        ...
        [Newtonsoft.Json.JsonProperty("consultation_room", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
