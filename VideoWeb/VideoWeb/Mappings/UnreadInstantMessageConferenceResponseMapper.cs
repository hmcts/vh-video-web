...
{
    public class UnreadInstantMessageConferenceCountResponseMapper : IMapTo<UnreadInstantMessageConferenceCountResponse, Conference, IList<InstantMessageResponse>>
    {
