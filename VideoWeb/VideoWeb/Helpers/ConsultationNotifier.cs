...
namespace VideoWeb.Helpers
{
    public class ConsultationNotifier : IConsultationNotifier
    {
        ...
        public ConsultationNotifier(IHubContext<EventHub.Hub.EventHubPR2079, IEventHubClient> hubContext, IConsultationInvitationTracker consultationInvitationTracker)
        {
