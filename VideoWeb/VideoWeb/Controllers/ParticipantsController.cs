...
namespace VideoWeb.Controllers
{
    ...
    public class ParticipantsController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetParticipantsWithContactDetailsByConferenceIdAsync(Guid conferenceId)
        {
            ...
            try
            {
                var participants = await
                    _participantService.GetParticipantsWithContactDetailsByConferenceIdAsync(conferenceId);
        ...
        public async Task<IActionResult> GetParticipantsByConferenceIdAsync(Guid conferenceId)
        {
            try
            {
                var participants = await _participantService.GetParticipantsByConferenceIdAsync(conferenceId);
        ...
        public async Task<IActionResult> GetCurrentParticipantAsync(Guid conferenceId)
        {
            try
            {
                var response = await _participantService.GetCurrentParticipantAsync(conferenceId, User);
