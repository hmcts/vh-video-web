...
export class CameraCheckComponent implements OnInit {
    ...
    get cameraCheck(): AbstractControl {
        return this.form.get('cameraCheck');
    }
    ...
    checkEquipmentAgain() {
        this.logger.info(
            `Camera check | ConferenceId : ${this.conferenceId} | Participant : ${this.participantName} requested check equipment again.`
        );
