...
export class VideoCheckComponent implements OnInit {
    ...
    get videoCheck(): AbstractControl {
        return this.form.get('videoCheck');
    }
    ...
    onSubmit() {
        ...
        if (this.form.invalid) {
            if (this.videoCheck.value === 'No') {
                ...
                this.logger.info(
                    `Video check | ConferenceId : ${this.conferenceId} | Participant : ${this.participantName} responded could not see and hear video.`
                );
    ...
    checkEquipmentAgain() {
        this.logger.info(
            `Video check | ConferenceId : ${this.conferenceId} | Participant : ${this.participantName} requested check equipment again.`
        );
