...
@Component({
    ...
    templateUrl: './judge-waiting-room2.component.html',
    styleUrls: ['./judge-waiting-room2.component.scss']
})
export class JudgeWaitingRoom2Component extends WaitingRoomBaseComponent implements OnInit, OnDestroy {
    constructor(
