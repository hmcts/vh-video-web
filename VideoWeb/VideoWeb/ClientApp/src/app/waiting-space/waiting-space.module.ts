...
@NgModule({
    ...
    providers: [VideoCallService, NotificationSoundsService, NotificationToastrService, RoomClosingToastrService, LoggedUserResolveService, ParticipantRemotemuteStoreService]
})
