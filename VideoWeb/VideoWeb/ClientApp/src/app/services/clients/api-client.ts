...
export class ApiClient extends ApiClientBase {
     ...
     * @return No Content
     */
    updatedAllocation(body: AllocationUpdatedRequest | undefined): Observable<void> {
        let url_ = this.baseUrl + '/internalevent/UpdatedAllocation';
        url_ = url_.replace(/[?&]$/, '');
        ...
        return _observableFrom(this.transformOptions(options_))
            ...
            .pipe(
                _observableMergeMap((response_: any) => {
                    return this.processUpdatedAllocation(response_);
                })
            )
            .pipe(
                _observableCatch((response_: any) => {
                    if (response_ instanceof HttpResponseBase) {
                        try {
                            return this.processUpdatedAllocation(response_ as any);
                        } catch (e) {
                            return _observableThrow(e) as any as Observable<void>;
                        }
                    } else return _observableThrow(response_) as any as Observable<void>;
    ...
    protected processUpdatedAllocation(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse
                ? response.body
...
export class ParticipantDetailsResponse implements IParticipantDetailsResponse {
    ...
    current_room?: RoomResponse;
    current_interpreter_room?: RoomResponse;
...
export class AllocationUpdatedRequest implements IAllocationUpdatedRequest {
    conferences?: ConferenceDetailsResponse[] | undefined;
    allocated_cso_username?: string | undefined;

    constructor(data?: IAllocationUpdatedRequest) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property)) (<any>this)[property] = (<any>data)[property];
            }
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data['conferences'])) {
                this.conferences = [] as any;
                for (let item of _data['conferences']) this.conferences!.push(ConferenceDetailsResponse.fromJS(item));
            }
            this.allocated_cso_username = _data['allocated_cso_username'];
        }
    }

    static fromJS(data: any): AllocationUpdatedRequest {
        data = typeof data === 'object' ? data : {};
        let result = new AllocationUpdatedRequest();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        if (Array.isArray(this.conferences)) {
            data['conferences'] = [];
            for (let item of this.conferences) data['conferences'].push(item.toJSON());
        }
...
export interface IAllocationUpdatedRequest {
    conferences?: ConferenceDetailsResponse[] | undefined;
    allocated_cso_username?: string | undefined;
}
