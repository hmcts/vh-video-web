        ...
        return this.http
            ...
            .pipe(
                _observableCatch((response_: any) => {
                    ...
                    } else return <Observable<ConferenceForUserResponse[]>>(<any>_observableThrow(response_));
                })
            );
    }
            ...
            return blobToText(responseBlob).pipe(
                _observableMergeMap(_responseText => {
                    ...
                    if (Array.isArray(resultData200)) {
                        result200 = [] as any;
                        for (let item of resultData200) result200!.push(ConferenceForUserResponse.fromJS(item));
                    }
...
export class ConferenceForUserResponse implements IConferenceForUserResponse {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data['tasks'])) {
                this.tasks = [] as any;
                for (let item of _data['tasks']) this.tasks!.push(TaskUserResponse.fromJS(item));
            }
        }
    }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.tasks)) {
            data['tasks'] = [];
            for (let item of this.tasks) data['tasks'].push(item.toJSON());
        }
        return data;
    }
}
