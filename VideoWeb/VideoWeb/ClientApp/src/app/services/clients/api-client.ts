...
export class ApiClient extends ApiClientBase {
                ...
                _observableCatch((response_: any) => {
                    if (response_ instanceof HttpResponseBase) {
                        try {
                            ...
                            return _observableThrow(e) as any as Observable<ConferenceDetailsResponse>;
                        }
                    } else return _observableThrow(response_) as any as Observable<ConferenceDetailsResponse>;
                })
            );
    }
    ...
    protected processStaffMemberJoinConference(response: HttpResponseBase): Observable<ConferenceDetailsResponse> {
        ...
        return _observableOf<ConferenceDetailsResponse>(null as any);
    }
