...
export class ClientSettingsResponse implements IClientSettingsResponse {
    ...
    blur_radius?: number;
    wowza_recorder_pexip_display_name?: string | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.wowza_recorder_pexip_display_name = _data['wowza_recorder_pexip_display_name'];
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data['wowza_recorder_pexip_display_name'] = this.wowza_recorder_pexip_display_name;
        return data;
    }
}
