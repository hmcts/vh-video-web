...
export class ErrorService {
    ...
    handlePexipError(error: CallError) {
        ...
        const extensionsOrFirewallIssues = ['a firewall may be blocking access', 'Please disable any privacy extensions on your browser', 'Failed to gather IP addresses'];
